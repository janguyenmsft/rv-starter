...
export const Home: React.FC<IHomeProps> = ({ className }) => {
  return (
    <div className='m-auto'>
      <h1 className='text-xl font-bold'>React & Tailwind CSS Starter Pack using Vite</h1>
      <p>Including Auth MSLA</p>
      <div className={`relative z-10 rounded-xl shadow-xl ${className ? className : ""}`}>
